Ext.define('Myapp.view.Edit_farmfield', {
...

                    {
                         ...
                         margin: '10',
                            handler: function () {
                                  ...
                                  var FarmFieldID=Ext.getCmp('farm11').getValue();
                                  var SupplierID=Ext.getCmp('farm12').getValue();
                                  Ext.Ajax.request({                                    
                                        url: 'http://107.180.73.170/api/v2/triton/_proc/Usp_FarmFields_Update('+FarmFieldID+','+FieldIDNumber+','+FieldName+','+SupplierID+','+LegalDescription+','+TotalAcres+','+IrrigationSource1+','+IrrigationSource2+','+IrrigationSource3+','+Comments+')?api_key=36fda24fe5588fa4285ac6c6c2fdfbdb6b6bc9834699774c9bf777f706d05a88',
                                        method: "GET",
