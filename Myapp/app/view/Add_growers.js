Ext.define('Myapp.view.Add_growers', {
    extend: 'Ext.Container',
     //extend: 'Ext.tab.Panel',
    xtype: 'add_growersview',
    requires: [
        'Ext.TitleBar'
        ...
        scrollable: true,
            ...
            items: [
                    ...
                    {  
                        docked: 'top',
                        xtype: 'titlebar',
                        title: 'Add Growers and Suppliers'
                    },
                    {
                        xtype: 'textfield',
                         ...
                         margin: '10',
                            handler: function () {
                               ...
                               var CompanyName=Ext.getCmp('grow').getValue();
                                  ...
                                  Ext.Ajax.request({                                    
                                        url: 'http://107.180.73.170/api/v2/triton/_proc/Usp_Suppliers_Insert('+CompanyName+','+ContactName+','+ContactTitle+','+Address+','+City+','+Region+','+PostalCode+','+Country+','+Phone+','+Fax+','+HomePage+','+Email+','+CompanyUCCprefix+','+SupplierID+')?api_key=36fda24fe5588fa4285ac6c6c2fdfbdb6b6bc9834699774c9bf777f706d05a88',
                                        method: "GET",
