...
Ext.define('Myapp.view.Add_pesticide', {
    extend: 'Ext.Container',
     //extend: 'Ext.tab.Panel',
    xtype: 'add_pesticideview',
    requires: [
        'Ext.TitleBar'
                         ...
                         margin: '10',
                            handler: function () {
                                ...
                                var PesticideName=Ext.getCmp('pesticide').getValue();
                                  ...
                                  Ext.Ajax.request({                                    
                                        url: 'http://107.180.73.170/api/v2/triton/_proc/Usp_Pesticides_Insert('+PesticideName+','+RatesListedPer+','+RestrictedUseData+','+RestrictedEntryLevelData+','+PesticideLabelSignalWord+','+WPSOralNotification+','+Formulation+','+ActiveIndegrident+','+EPARegistrationNumber+','+RestrictedEntryInterval+','+ProductRate+','+ProductMeasurementTypeID+','+TotalProductConsumed+','+ApplicatorName+','+CertificationNumber+','+Speed+','+MPH+','+GPA+','+Concentration+','+SprayRig+','+NozzelSetup+','+SprayingInstructions+')?api_key=36fda24fe5588fa4285ac6c6c2fdfbdb6b6bc9834699774c9bf777f706d05a88',
                                        method: "GET",
